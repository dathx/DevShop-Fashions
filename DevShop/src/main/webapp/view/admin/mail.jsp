...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="admin/images/favicon.ico">
          ...
          <title>Dev Shop - Admin Mail</title>

        <link href="admin/plugins/summernote/summernote-bs4.css" rel="stylesheet" /><!-- Custom box css -->
        <link href="admin/plugins/custombox/dist/custombox.min.css" rel="stylesheet">
    ...
    <body class="fixed-left">
                                                            ...
                                                            <li class="unread">
                                                                ...
                                                                <div class="mail-col mail-col-2">
                                                                    <div class="subject">Sveriges Hetaste sommarjobb &nbsp;&ndash;&nbsp;
                                                                        <span class="teaser">Hej Nicklas Sandell! Vi vill bjuda in dig till "First tour 2014", ett rekryteringsevent som erbjuder jobb pÃ¥ 16 semesterorter iSverige.</span>
                                                                    </div>
                                                                    <div class="date">Mar 8</div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="orange-dot">
                                                                ...
                                                                <div class="mail-col mail-col-2">
                                                                    <div class="subject">This Week's Top Stories &nbsp;&ndash;&nbsp;
                                                                        <span class="teaser">Our top pick for you on Medium this week The Man Who Destroyed Americaâs Ego</span>
                                                                    </div>
        ...
        <div id="custom-modal" class="modal-demo text-left">
            ...
            <div class="card-box">
                <form:form action="/mail/send" role="form" method="post" enctype="multipart/form-data" modelAttribute="mailinfo">
                    <div class="form-group">
                           <form:input path="to" type="email" class="form-control" placeholder="To"/>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                    ...
                    <div class="btn-toolbar form-group m-b-0">
                        <div class="pull-right">
                            ...
                            <button type="submit" class="btn btn-purple waves-effect waves-light"><span>Send</span> <i
        ...
        <script src="admin/pages/jquery.inbox.js"></script>

        <!--form validation init-->
        <script src="admin/plugins/summernote/summernote-bs4.min.js"></script>

        <!-- Modal-Effect -->
        <script src="admin/plugins/custombox/dist/custombox.min.js"></script>
        <script src="admin/plugins/custombox/dist/legacy.min.js"></script>
