...
<head>
    ...
    <link rel="shortcut icon" href="admin/images/favicon.ico">
      ...
      <title>Dev Shop - Admin Edit Product</title>
 <!-- form Uploads -->
                                ...
                                <div class="col-12">
                                    <div class="p-20">
                                           <form:form  class="form-horizontal" role="form"  modelAttribute="item">       
                                            ...
                                            <div class="form-group row">
                                                <label class="col-2 col-form-label">CREATE DATE (yyyy/MM/yy)</label>
                                                <div class="col-10">
                                           ...
                                           <div class="form-group row">
                                                <label class="col-2 col-form-label">AVAILABLE</label>
                                               <div class="radio radio-info form-check-inline">
                                               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;      &nbsp;&nbsp;&nbsp;                           
		                                        <form:radiobutton class="custom-control-input" id="inlineRadio1" value="true" checked="true" path="available"/>
		                                        <label for="inlineRadio1"> ON </label>
			                                    </div>
			                                    <div class="radio radio-warning form-check-inline">
			                                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			                                    <form:radiobutton class="custom-control-input" id="inlineRadio2" value="false"  path="available"/>                     
                                              ...
                                              <div class="card-box">
													...
													<form:input  type="file" data-default-file="images/products/${item.image}"  class="dropify" data-max-file-size="1M" path="image"/>
				                              </div>				                              
				                              <div class="form-group row">
											...
											<a class="btn btn-light" href="/admin-list-product">Reset</a>
                                        </form:form>
