...
<head>
    ...
    <link rel="shortcut icon" href="admin/images/favicon.ico">
      ...
      <title>Dev Shop - Admin List Account</title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title">LIST ACCOUNT</h4>
                            ...
                            <table id="datatable" class="table table-bordered">
                                ...
                                <c:forEach var="item" items="${items}">
                                    ...
                                    <tr>
                                        ...
                                        <td>${item.fullname}</td>
                                        <td>${item.email}</td>
                                        <td>${item.role?'User':'Admin'}</td>
                                        <td>${item.activated?'On':'Off'}</td>
                                        <td>${item.image}</td>
                                        <td><a   href="/account-edit-${item.username}"><span class="glyphicon glyphicon-edit"></span> Edit</a></td>
                                    </tr>
