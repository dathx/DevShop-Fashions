 ...
 <%@include file="function/header.jsp"%>
  ...
  <section class="page-name-sec page-name-sec-01">
    <div class="section-padding">
      <div class="container">
        <h3 class="page-title">Login</h3><!-- /.page-title -->
        ...
        <div class="col-md-3 "></div>
          <div class="col-md-6 ">
            <div class="sign-in bg-gray">
              ...
              <form class="sign-in-form" id="sign-in-form" action="/login" method="post">
               <h3>${message }</h3>
               <br>
                <p class="form-input">
                ...
                <p class="checkbox pull-left">
                  <input name="remember" type="checkbox" class="rememberme" value="true"/> 
                  Remember Me
                  <a href="/forgotpassword" class="pull-right" title="Recover Your Lost Password">Forgot password?</a>
                </p>
              </form>
